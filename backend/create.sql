create table tb_order (id int8 generated by default as identity, address varchar(255), latidude float8, longitude float8, moment timestamp, status int4, primary key (id));
